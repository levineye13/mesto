...
**<ins>[В данном сервисе](https://levineye13.github.io/mesto/dist/index.html)</ins>** представлены иллюстрации замых захватывающих мест России.
...
- [Работы с API](https://developer.mozilla.org/ru/docs/Learn/JavaScript/Client-side_web_APIs/Introduction)
